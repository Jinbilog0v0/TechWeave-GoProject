...
const ProfilePage = () => {
  // Access shared user state from Layout via Outlet context
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      // Update the global user context immediately so sidebar updates too
        ...
        <div className="md:col-span-1 space-y-6">
          <div className="bg-white p-6 rounded-xl shadow-sm border flex flex-col items-center text-center">
              ...
              <div className="w-32 h-32 rounded-full overflow-hidden border-4 border-green-50 bg-gray-200 flex items-center justify-center">
                {previewImage ? (
                  <img src={previewImage} alt="Preview" className="w-full h-full object-cover" />
                   ...
                   // Adjust the URL prefix if your Django server runs on a specific port
                  <img src={`http://127.0.0.1:8000${user.profile.profile_picture}`} alt="Profile" className="w-full h-full object-cover" />
                ) : (
                  <span className="text-4xl font-bold text-gray-400">{getInitials(user?.username)}</span>
                )}
              </div>
            ...
            <div className="mt-4">
              ...
              <p className="text-sm text-green-700 font-medium">{user?.profile?.role || "Student"}</p>
            </div>
          </div>
        </div>
          ...
          <form onSubmit={handleSubmit} className="bg-white p-8 rounded-xl shadow-sm border space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="username" name="username" value={formData.username} onChange={handleChange} className="pl-10"/>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="email" name="email" value={formData.email} onChange={handleChange} className="pl-10"/>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                ...
                <div className="space-y-2">
                  ...
                  <div className="relative">
                    ...
                    <Input id="course" name="course" placeholder="e.g. BSIT" value={formData.course} onChange={handleChange} className="pl-10"/>
                  </div>
                </div>
              </div>
              ...
              <div className="space-y-2">
                ...
                <Textarea id="bio" name="bio" placeholder="Tell us about yourself..." className="min-h-[100px]" value={formData.bio} onChange={handleChange}/>
              </div>
            </div>
