        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
          ...
          <div className="flex items-center gap-4">
            <div className="bg-green-50 px-4 py-2 rounded-lg border border-green-100">
               ...
               <span className="text-xl font-bold text-green-800 flex items-center"> <PhilippinePeso size={18} /> {totalExpenseAmount.toFixed(2)}</span>
            </div>
            {!showExpenseForm && (
              <button
            ...
            expenses.map((expense) => (
              <div key={expense.id} className="bg-white p-4 rounded-xl border border-gray-200 shadow-sm hover:shadow-md transition flex justify-between items-center">
                ...
                <div className="flex items-center gap-6">
                  <span className="text-lg font-bold text-gray-900 flex items-center">- <PhilippinePeso size={12}/> {parseFloat(expense.amount).toFixed(2)}</span>
                  <button 
